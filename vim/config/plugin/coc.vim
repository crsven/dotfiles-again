...
set statusline^=%{get(b:,'coc_current_function','')}\ %f%m
...
" Ag integration
nnoremap <silent> <space>g  :execute "CocList grep ".input("Text to search? ")<CR>
nnoremap <silent> <leader>ff :execute "CocList grep ".expand("<cword>")<CR>
